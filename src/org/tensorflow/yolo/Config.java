...
public interface Config {
    int INPUT_SIZE = 224;//416;   // The input size. A square image of inputSize x inputSize is assumed.
    int IMAGE_MEAN = 128;   // The assumed mean of the image values.
    float IMAGE_STD = 128.0f;   // The assumed std of the image values.
    String MODEL_FILE = "comon_output_quant.tflite";   // The filepath of the model GraphDef protocol buffer.
    String LABEL_FILE = "comon_model_labels.txt"; // The filepath of label file for classes.
